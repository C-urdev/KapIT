const PAYPAL_ISSUE_MESSAGE_MAP: Readonly<Record<string, string>> = Object.freeze({
...
const readIssueFromError = (error: any): string => {
...
const stripProviderDebugFragments = (rawMessage: unknown): string => {
