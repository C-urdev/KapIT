...
const HOW_IT_WORKS_STEPS = [
  {
    ...
    description: "Sign up and complete your developer profile or set up your company account. Let us know exactly what you're looking for.",
    Icon: Users,
  ...
  },
  {
    step: 'Step 2',
    title: 'Showcase work.',
    description: 'Developers can showcase their portfolios and past work, while companies can post IT projects with clear requirements.',
    Icon: Code2,
  ...
  },
  {
    step: 'Step 3',
    title: 'Connect & build.',
    description: 'Reach out to matches, interview smoothly on our platform, and start collaborating seamlessly to build great things.',
    Icon: Sparkles,
