  ...
  return (
    <div
      className={`px-4 sm:px-5 ${
        !isRead ? 'bg-[#eef3ea] dark:bg-[#2a2f35]' : 'bg-transparent'
      }`}
    >
      <div className={`py-4 ${showDivider ? 'border-b border-[#dde4d4] dark:border-[#444d57]' : ''}`}>
        <div className="flex items-start gap-3">
          <div className="relative flex-shrink-0">
            <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-full bg-[#dfe8d8] text-lg font-semibold text-[#2f4f39] dark:bg-[#2f343b] dark:text-white">
              {initials}
            </div>
  ...
  return (
    <div className="fixed inset-0 z-[120]">
      ...
      <div className="absolute inset-x-0 bottom-0 flex items-end justify-center px-0 pb-0 xl:inset-0 xl:px-6 xl:pb-6">
        <div className="w-screen max-w-none rounded-t-[32px] border-t border-[#bfd0af] bg-[#dad7cd] px-4 pb-6 pt-3 text-[#344e41] shadow-[0_-18px_42px_rgba(58,90,64,0.18)] xl:w-full xl:max-w-md xl:rounded-[32px] xl:border xl:shadow-[0_24px_80px_rgba(58,90,64,0.2)] dark:border-[#444d57] dark:bg-[#1f2328] dark:text-white">
          ...
          <div className="px-6 pb-6 pt-5 text-center xl:px-8 xl:pb-5 xl:pt-4">
            <div className="mx-auto relative flex h-20 w-20 items-center justify-center overflow-visible rounded-full bg-[#dfe8d8] text-[1.75rem] font-semibold text-[#2f4f39] dark:bg-[#2f343b] dark:text-white">
              {item.initials}
          ...
          <div className="hidden px-4 pb-4 pt-1 xl:block xl:px-6">
            <button
              type="button"
              onClick={onClose}
              className="flex w-full items-center justify-center gap-2 rounded-2xl border border-[#bfd0af] bg-[#f8fbf6]/92 px-4 py-3 text-sm font-semibold text-[#344e41] transition-colors hover:bg-[#f1f5eb] dark:border-[#4b5560] dark:bg-[#2f343b]/92 dark:text-[#e2e6e9] dark:hover:bg-[#3a4048]"
            >
              <X className="h-4 w-4" />
              Close
            </button>
