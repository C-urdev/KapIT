...
import { LogOut, Moon, PanelLeftClose, PanelLeftOpen, Settings, Sun, Bell, HelpCircle } from 'lucide-react';
import { useTheme } from '@sharedContext/ThemeContext';
import { COMPANY_PATHS, navigate } from '@companyFeatures/companyUtils';

export default function CompanyDesktopHeader({ title, user, onLogout, onHelp, sidebarCollapsed, onToggleSidebarCollapsed, unreadNotificationCount = 0 }) {
