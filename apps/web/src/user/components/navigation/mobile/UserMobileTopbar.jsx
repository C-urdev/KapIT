    ...
    <div className="flex w-full items-center justify-between gap-3 py-1.5" style={{ paddingTop: 'max(0.45rem, env(safe-area-inset-top))' }}>
      <div className="flex items-center gap-3 min-w-0">
        <button
          ...
          className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#a3b18a] bg-white text-[#344e41] transition-colors hover:bg-[#f5f5f2] dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 shrink-0"
      ...
      <div className="flex items-center gap-2 shrink-0">
        <button
          ...
          className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#a3b18a] bg-white text-[#344e41] transition-colors hover:bg-[#f5f5f2] dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
