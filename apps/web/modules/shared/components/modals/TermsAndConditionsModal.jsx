      ...
      <div className="flex w-full max-w-3xl flex-col bg-white dark:bg-[#0a1628] rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] animate-in zoom-in-95 duration-200">
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-[#e5e7eb] dark:border-[#1e3a5f] p-4 sm:p-5">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#f0f4ec] dark:bg-[#1e3a5f]">
              <Book className="w-5 h-5 text-[#3a5a40] dark:text-[#3ba9d6]" />
            </div>
            <div>
        ...
        >
          ...
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">1. Use of the Platform</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 2 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">2. User Accounts</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 3 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">3. User Conduct</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 4 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">4. Communication Between Users</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 5 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">5. Fees and Payments</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 6 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">6. Intellectual Property</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 7 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">7. Data and Privacy</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 8 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">8. Limitation of Liability</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 9 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">9. Termination</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 10 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">10. Changes to the Terms</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 11 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">11. Governing Law</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
          ...
          {/* Section 12 */}
          <section className="space-y-4">
            <h4 className="text-[17px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">12. Contact Information</h4>
            <div className="space-y-4 text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed text-[14.5px]">
        ...
        {showDecisionActions && (
          <div className="shrink-0 border-t border-[#e5e7eb] dark:border-[#1e3a5f] p-4 sm:p-5">
            {decisionError ? (
            ...
            <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
              <button
                ...
                className="rounded-lg border border-[#a3b18a] dark:border-[#2a4a6f] px-4 py-2.5 text-sm font-semibold text-[#3a5a40] dark:text-white transition-colors hover:bg-[#f5f5f2] dark:hover:bg-[#1e3a5f] disabled:cursor-not-allowed disabled:opacity-60"
              >
                {declineLabel}
              </button>
              <button
