    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 min-[420px]:p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="flex w-full max-w-3xl flex-col bg-white dark:bg-[#0a1628] rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] animate-in zoom-in-95 duration-200">
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-[#e5e7eb] dark:border-[#1e3a5f] p-4 sm:p-5">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#f0f4ec] dark:bg-[#1e3a5f]">
              <Globe className="w-5 h-5 text-[#3a5a40] dark:text-[#3ba9d6]" />
            </div>
        ...
        <main className="flex-1 overflow-y-auto p-5 sm:p-7 lg:p-8 space-y-6 custom-scrollbar">
          ...
          <div className="bg-[#f8fbf6] dark:bg-[#102235] rounded-xl p-5 border border-[#dce5d4] dark:border-[#1e3a5f]">
            <p className="text-[14.5px] text-[#344e41] dark:text-[#d5e6f5] leading-relaxed">
          ...
          <section className="space-y-3">
            <h4 className="text-[16px] font-bold text-[#1c2b1f] dark:text-white border-b border-[#dce5d4] dark:border-[#1e3a5f] pb-2">
              What Are Cookies?
            </h4>
            <p className="text-[14.5px] text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-4 text-[14.5px] text-[#4b5563] dark:text-[#b8d4e8] leading-relaxed">
              <div>
        ...
        {/* Footer Actions */}
        <div className="flex flex-col sm:flex-row items-center justify-end gap-3 border-t border-[#e5e7eb] dark:border-[#1e3a5f] p-4 sm:p-5 bg-[#f9fafb] dark:bg-[#0d1b2e]">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-6 py-2.5 text-sm font-semibold text-[#344e41] dark:text-white hover:bg-black/5 dark:hover:bg-white/5 rounded-lg transition-colors border border-[#d1d5db] dark:border-[#1e3a5f]"
          >
            Manage Preferences
          </button>
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-6 py-2.5 text-sm font-semibold text-white bg-[#3a5a40] hover:bg-[#344e41] dark:bg-[#3ba9d6] dark:hover:bg-[#5bc0de] rounded-lg shadow-sm transition-colors"
          >
            Accept All Cookies
          </button>
        </div>
