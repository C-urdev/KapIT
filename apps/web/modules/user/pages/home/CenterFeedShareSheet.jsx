  ...
  return (
    <div className="fixed inset-0 z-[95] flex items-end bg-[#344e41]/18 backdrop-blur-[2px] dark:bg-black/35 dark:backdrop-blur-[2px]" onClick={onClose}>
      <div className="max-h-[88vh] w-full overflow-y-auto rounded-t-[2rem] border-t border-[#bfd0af] bg-[linear-gradient(180deg,#ebe7dc_0%,#dad7cd_100%)] px-4 pb-6 pt-3 text-[#344e41] shadow-2xl dark:border-[#2a4a6f] dark:bg-[#23262b] dark:text-white" style={{ paddingBottom: 'max(1.5rem, calc(env(safe-area-inset-bottom) + 1rem))' }} onClick={(event) => event.stopPropagation()}>
        ...
        <div className="mx-auto w-full max-w-4xl rounded-[1.75rem] border border-[#bfd0af] bg-[#f8fbf6] p-5 shadow-[0_14px_34px_rgba(58,90,64,0.1)] dark:border-[#314a68] dark:bg-[#34343a] dark:shadow-none">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-2 flex flex-wrap gap-2 text-sm">
                ...
                <div className="relative" ref={visibilityMenuRef}>
                  ...
                  {visibilityMenuOpen ? (
                    <div className="absolute left-0 top-[calc(100%+0.5rem)] z-20 min-w-56 overflow-hidden rounded-2xl border border-[#bfd0af] bg-[#f8fbf6] shadow-[0_12px_30px_rgba(58,90,64,0.12)] dark:border-[#314a68] dark:bg-[#34343a]">
        ...
        <section className="mx-auto mt-6 w-full max-w-4xl rounded-[1.75rem] border border-[#bfd0af] bg-[#f8fbf6] px-5 py-5 shadow-[0_14px_34px_rgba(58,90,64,0.08)] dark:border-[#314a68] dark:bg-[#2b2f35] dark:shadow-none">
