...
export default function UserSearchResultsPage({
  ...
  return (
    <div className="mx-auto w-full max-w-[min(100%,980px)]">
      <section className="rounded-2xl border border-[#a3b18a] bg-[#f8fbf6] p-3 shadow-sm dark:border-[#2a4a6f] dark:bg-[#162842] sm:p-4">
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={onBack}
            className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full text-[#344e41] transition-colors hover:bg-[#f1f3ec] dark:text-white dark:hover:bg-[#1e3a5f]"
            aria-label="Back"
          >
          ...
          <div className="relative min-w-0 flex-1">
            ...
            <input
              ...
              className="w-full rounded-full border border-[#b8c4a4] bg-[#f1f3ec] py-3 pl-11 pr-4 text-base text-[#344e41] outline-none transition-colors placeholder:text-[#6b7280] focus:ring-2 focus:ring-[#588157] dark:border-[#2a4a6f] dark:bg-[#102235] dark:text-white dark:placeholder:text-white/40 dark:focus:ring-[#3ba9d6]"
            />
          </div>
        </div>
          ...
          <div className="space-y-1">
            {results.map((result) => (
              <button
                ...
                className="flex w-full items-center gap-3 rounded-2xl border border-transparent bg-[#f8fbf6] px-3 py-3 text-left transition-colors hover:border-[#c7ceba] hover:bg-[#f1f3ec] dark:bg-[#162842] dark:hover:border-[#2a4a6f] dark:hover:bg-[#1e3a5f]"
              >
                <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#588157] font-bold text-white dark:bg-[#3ba9d6]">
                  {result.profileImage ? (
                    <img
