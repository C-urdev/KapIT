  ...
  if (error || !profile) {
    return (
      <div className="space-y-4">
        ...
        <div className="max-w-2xl rounded-2xl border border-[#bfd0af] bg-[#f8fbf6] p-5 shadow-sm shadow-black/5 dark:border-[#2a4a6f] dark:bg-[#162842]">
          <h2 className="text-xl font-bold text-[#1c2b1f] dark:text-white">Public profile is not available yet</h2>
          <p className="mt-2 text-sm text-[#4b5f4a] dark:text-[#b8d4e8]">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex items-center rounded-lg bg-[#3a5a40] px-3.5 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#344e41] dark:bg-[#3ba9d6] dark:hover:bg-[#5bc0de]"
            >
            ...
            <button
              type="button"
              onClick={handleBack}
              className="inline-flex items-center rounded-lg border border-[#a3b18a] px-3.5 py-2 text-sm font-semibold text-[#344e41] transition-colors hover:bg-[#f1f5eb] dark:border-[#2a4a6f] dark:text-white dark:hover:bg-[#1e3a5f]"
            >
              Go back
            </button>
          </div>
