...
function PlanCard({ plan }) {
  return (
    <div className={`rounded-[22px] border p-5 transition-colors ${
      ...
      <p className="mt-2 text-sm text-[#344e41] dark:text-[#b8d4e8]">Active for {plan.durationLabel}</p>
    </div>
  );
}
      ...
      <div className="flex min-h-full items-end justify-center p-2 pt-[max(0.75rem,env(safe-area-inset-top))] pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:items-center sm:p-4">
        <div className="flex max-h-[min(92vh,960px)] w-full max-w-5xl flex-col overflow-hidden rounded-[24px] border border-[#a3b18a] bg-[#f8fbf6] shadow-[0_30px_80px_rgba(0,0,0,0.18)] dark:border-[#2a4a6f] dark:bg-[#162842] dark:shadow-[0_30px_80px_rgba(0,0,0,0.45)] sm:rounded-[28px]">
          ...
          <div className="overflow-y-auto px-4 py-4 sm:px-6 sm:py-6">
            <div className="mb-4 rounded-[18px] border border-[#d6d3c9] bg-[#f8fbf6] p-3.5 dark:border-[#24415f] dark:bg-[#102138]">
              <p className="text-sm font-semibold text-[#102a1b] dark:text-white">Payment Method</p>
              <p className="mt-1 inline-flex items-center gap-2 text-sm text-[#344e41] dark:text-[#dcecff]">
                <WalletCards className="h-4 w-4 text-[#588157] dark:text-[#7fd0ee]" />
            ...
            <div className="mt-6 rounded-[20px] border border-[#d6d3c9] bg-[#f8fbf6] p-4 dark:border-[#24415f] dark:bg-[#102138]">
