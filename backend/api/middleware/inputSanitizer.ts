...
class InputValidationError extends Error {
  ...
  constructor(message: string, { path = '', statusCode = 400, code = 'invalid_input' }: any = {}) {
    super(message);
...
const buildLimits = (overrides: any = {}) => ({
...
const sanitizeAndValidateInput = (value: any, overrides: any = {}): any => {
  ...
  const visit = (current: any, path: string, depth: number): any => {
    state.nodeCount += 1;
