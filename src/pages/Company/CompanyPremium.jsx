...
import { Briefcase, Check, Crown, MessageCircle, Search, ShieldCheck } from 'lucide-react';
...
export default function CompanyPremium() {
  return (
    <div className="mx-auto max-w-5xl overflow-hidden rounded-[28px] border border-[#a3b18a] bg-white shadow-[0_30px_80px_rgba(0,0,0,0.18)] dark:border-white/10 dark:bg-[#171717] dark:shadow-[0_30px_80px_rgba(0,0,0,0.35)]">
