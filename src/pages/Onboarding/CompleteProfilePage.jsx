              ...
              <select
                ...
                onChange={(event) =>
                  setFormData({
                    ...
                    vocationalCourse: event.target.value === VOCATIONAL_OPTION ? formData.vocationalCourse : '',
                  })
                }
                className="w-full input-base"
                required
            ...
            <Field label="Preferred IT Job">
              <select
                ...
                onChange={(event) =>
                  setFormData({
                    ...formData,
                    desiredJob: event.target.value,
                    customDesiredJob: event.target.value === OTHER_JOB_OPTION ? formData.customDesiredJob : '',
                  })
                }
                className="w-full input-base"
                required
