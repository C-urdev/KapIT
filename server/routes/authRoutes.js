...
const { register, login, refreshSession, logout, getCurrentUser, searchUsers, getPublicProfile, updateMyProfile, getJobsFeed, getMyApplications, applyToJob } = require('../controllers/authController');
